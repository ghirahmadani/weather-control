...
const Floating = (props) => {
  return (
    <button className="" onClick={props.click}>
        <svg className='animate-bounce w-12 h-12 text-[#323368] cursor-pointer' fill="currentColor" viewBox="0 0 20 20" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">
